...
const user_router=new UserRouter(new UserLoginService(),new WalletService(),new TransactionService(),new GPSService(),new NFCService(new CompanyLoginService(),new DriverLoginService(),new UserLoginService(),new TripsService(),new TransactionService(),new WalletService()));
